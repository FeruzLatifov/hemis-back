...
public class WebLanguageController {
    ...
    public ResponseEntity<ResponseWrapper<List<Map<String, Object>>>> getAllLanguages() {
        ...
        List<Map<String, Object>> languageData = languages.stream()
            .map(this::languageToMap)
            .collect(Collectors.toList());

        return ResponseEntity.ok(ResponseWrapper.success(languageData));
    }
    ...
    public ResponseEntity<ResponseWrapper<List<Map<String, Object>>>> getActiveLanguages() {
    ...
    public ResponseEntity<ResponseWrapper<Map<String, Object>>> getSystemConfiguration() {
        ...
        List<Map<String, Object>> languageList = languages.stream()
            .map(lang -> {
                ...
                langMap.put("enabled", lang.isActive());
                langMap.put("canDisable", !lang.isSystemDefault());
                return langMap;
            })
            .collect(Collectors.toList());
    ...
    private Map<String, Object> languageToMap(Language language) {
        ...
        map.put("nativeName", language.getNativeName());
        map.put("isoCode", language.getIsoCode());
        map.put("position", language.getPosition());
        map.put("isActive", language.isActive());
        map.put("isDefault", language.isDefault());
        map.put("isRtl", language.isRtl());
        map.put("canDisable", !language.isSystemDefault());
        return map;
    }
}
