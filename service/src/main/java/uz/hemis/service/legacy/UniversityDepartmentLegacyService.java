...
public class UniversityDepartmentLegacyService {
    ...
    // ==================== Cathedra Service Query ====================

    /**
     * Get cathedras (departments) by university code - raw SQL for CUBA REST API compatibility.
     *
     * <p>Extracted from CathedraServiceController to follow Clean Architecture.</p>
     * <p>Uses raw SQL because Department entity mapping doesn't match legacy DB schema.</p>
     *
     * @param university university code
     * @return response map with success, count, and data list in CUBA format
     */
    public Map<String, Object> getCathedrasByUniversity(String university) {
