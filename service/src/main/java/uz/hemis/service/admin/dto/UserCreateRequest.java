...
public class UserCreateRequest {
    ...
    @Schema(description = "Email address", nullable = true)
    private String email;

    @ValidPhoneNumber
    @Size(max = 50, message = "Phone must be at most 50 characters")
    @Schema(description = "Phone number (UZ format +998XXXXXXXXX)", nullable = true)
    private String phone;

    @Size(max = 255, message = "University code must be at most 255 characters")
    @Schema(description = "University code (null for system admins)", nullable = true)
    ...
    @Schema(description = "Birth date yyyy-MM-dd", nullable = true)
    private String birthDate;

    @Size(max = 255) @Schema(nullable = true) private String birthPlace;

    @Size(max = 16) @Schema(description = "Passport series+number", nullable = true)
