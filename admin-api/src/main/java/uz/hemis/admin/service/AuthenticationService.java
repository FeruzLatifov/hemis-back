...
public class AuthenticationService {
    ...
    private List<PermissionDTO> loadUserPermissions(User user) {
        // TODO: Load from sec_role_assignment and sec_permission tables
        // For now, return full access for all entities (development mode)
        ...
        // Example permissions:
        permissions.add(PermissionDTO.fullAccess("EStudent"));
        permissions.add(PermissionDTO.fullAccess("ETeacher"));
        permissions.add(PermissionDTO.fullAccess("EUniversity"));
