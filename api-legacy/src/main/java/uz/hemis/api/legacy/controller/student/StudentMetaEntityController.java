...
import uz.hemis.service.student.StudentMetaService;
...
public class StudentMetaEntityController {
    ...
    private String buildInstanceName(StudentMetaDto dto) {
        return "com.company.hemishe.entity.EStudentMeta-" +
                (dto.getId() != null ? dto.getId() : "new") + " [detached]";
    }
    ...
    public ResponseEntity<Map<String, Object>> getById(
        ...
        try {
            ...
            cubaMap.put("_instanceName", buildInstanceName(dto));
    ...
    public ResponseEntity<List<Map<String, Object>>> getAll(
        ...
        // CUBA Platform REST API default: no specific sort (uses database order, typically by id)
    ...
    public ResponseEntity<Map<String, Object>> update(
        ...
        try {
            ...
            cubaMap.put("_instanceName", buildInstanceName(updated));
            return ResponseEntity.ok(cubaMap);
