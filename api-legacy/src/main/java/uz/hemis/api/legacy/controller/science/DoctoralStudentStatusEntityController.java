...
public class DoctoralStudentStatusEntityController {
    ...
    public ResponseEntity<?> getById(
        ...
        Optional<DoctoralStudentStatus> entity = scienceService.findDoctoralStudentStatusById(entityId);
        ...
        return ResponseEntity.ok(scienceService.toDoctoralStudentStatusMap(entity.get(), returnNulls));
    }
    ...
    public ResponseEntity<?> update(
        ...
        Optional<DoctoralStudentStatus> existingOpt = scienceService.findDoctoralStudentStatusById(entityId);
        ...
        DoctoralStudentStatus saved = scienceService.saveDoctoralStudentStatus(entity);

        return ResponseEntity.ok(scienceService.toDoctoralStudentStatusMap(saved, false));
    }
    ...
    public ResponseEntity<?> delete(
        ...
        scienceService.deleteDoctoralStudentStatus(entity.get());
    ...
    public ResponseEntity<List<Map<String, Object>>> listAll(
        ...
        List<DoctoralStudentStatus> allEntities = scienceService.findAllDoctoralStudentStatus();
        ...
        List<Map<String, Object>> result = paged.stream()
            .map(e -> scienceService.toDoctoralStudentStatusMap(e, returnNulls))
    ...
    public ResponseEntity<?> create(@RequestBody Map<String, Object> entityData) {
        ...
        try {
            DoctoralStudentStatus entity = scienceService.upsertDoctoralStudentStatus(code, name, nameRu, nameEn);

            return ResponseEntity.status(201).body(scienceService.toDoctoralStudentStatusMinimalMap(entity));
