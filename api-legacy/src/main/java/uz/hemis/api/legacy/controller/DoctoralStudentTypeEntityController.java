...
import uz.hemis.domain.repository.DoctoralStudentTypeRepository;
...
public class DoctoralStudentTypeEntityController {
    ...
    private final DoctoralStudentTypeRepository repository;
    ...
    public ResponseEntity<?> getById(
        ...
        Optional<DoctoralStudentType> entity = repository.findById(entityId);
    ...
    public ResponseEntity<?> update(
        ...
        Optional<DoctoralStudentType> existingOpt = repository.findById(entityId);
        ...
        DoctoralStudentType saved = repository.save(entity);
    ...
    public ResponseEntity<List<Map<String, Object>>> listAll(
        ...
        List<DoctoralStudentType> allEntities = repository.findAll();
    ...
    public ResponseEntity<?> create(@RequestBody Map<String, Object> entityData) {
        ...
        try {
            ...
            DoctoralStudentType entity = repository.findById(code).orElseThrow();
    ...
    private Map<String, Object> toMap(DoctoralStudentType entity, Boolean returnNulls) {
