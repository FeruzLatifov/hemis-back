...
public class PublicationLocalityEntityController {
    ...
    public ResponseEntity<?> getById(
        ...
        Optional<PublicationLocality> entity = scienceService.findPublicationLocalityById(entityId);
        ...
        return ResponseEntity.ok(scienceService.toPublicationLocalityMap(entity.get(), returnNulls));
    }
    ...
    public ResponseEntity<?> update(
        ...
        Optional<PublicationLocality> existingOpt = scienceService.findPublicationLocalityById(entityId);
        ...
        PublicationLocality saved = scienceService.savePublicationLocality(entity);

        return ResponseEntity.ok(scienceService.toPublicationLocalityMap(saved, false));
    }
    ...
    public ResponseEntity<?> delete(
        ...
        scienceService.deletePublicationLocality(entity.get());
    ...
    public ResponseEntity<List<Map<String, Object>>> listAll(
        ...
        List<PublicationLocality> allEntities = scienceService.findAllPublicationLocality();
        ...
        List<Map<String, Object>> result = paged.stream()
            .map(e -> scienceService.toPublicationLocalityMap(e, returnNulls))
    ...
    public ResponseEntity<?> create(@RequestBody Map<String, Object> entityData) {
        ...
        try {
            PublicationLocality entity = scienceService.upsertPublicationLocality(code, name, nameRu, nameEn);

            return ResponseEntity.status(201).body(scienceService.toPublicationLocalityMinimalMap(entity));
