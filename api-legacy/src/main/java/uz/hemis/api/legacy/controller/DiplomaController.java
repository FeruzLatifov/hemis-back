...
import uz.hemis.service.DiplomaService;
 ...
 * @since 1.0.0
 */
@Tag(name = "03. Modern Web APIs - Diplomas", description = "RESTful endpoints for diploma issuance, verification and management")
@RestController
