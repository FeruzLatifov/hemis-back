...
/**
 * University Student Status Controller - CUBA REST API Pattern
 *
 * <p><strong>CRITICAL - OLD-HEMIS Compatibility:</strong></p>
 * <ul>
 *   <li>Entity name: hemishe_HStudentStatus</li>
 *   <li>Maps to Classifier entity with type: STUDENT_STATUS</li>
 *   <li>Base URL: /app/rest/v2/entities/hemishe_HStudentStatus</li>
...
public class StudentStatusController {
    ...
    private static final String CLASSIFIER_TYPE = "STUDENT_STATUS";

    // =====================================================
    // 1. GET BY ID
    // =====================================================

    @Operation(summary = "Get student status by ID",
    ...
    public ResponseEntity<Map<String, Object>> getById(
        ...
        log.info("GET student status by ID: {}", entityId);
    ...
    public ResponseEntity<Map<String, Object>> update(
        ...
        log.info("UPDATE student status: {}", entityId);
    ...
    @Operation(summary = "Delete student status",
    ...
    public ResponseEntity<Void> delete(
        ...
        log.info("DELETE student status: {}", entityId);
    ...
    @Operation(summary = "Search student statuss (GET)",
    ...
    public ResponseEntity<List<Map<String, Object>>> searchGet(
        ...
        log.info("SEARCH student statuss (GET) - filter: {}", filter);
    ...
    @Operation(summary = "Search student statuss (POST)",
    ...
    public ResponseEntity<List<Map<String, Object>>> searchPost(
        ...
        log.info("SEARCH student statuss (POST) - filter: {}", filterBody);
    ...
    @Operation(summary = "Get all student statuss",
    ...
    public ResponseEntity<List<Map<String, Object>>> listAll(
        ...
        log.info("LIST ALL student statuss");
    ...
    @Operation(summary = "Create new student status",
    ...
    public ResponseEntity<Map<String, Object>> create(@RequestBody Map<String, Object> entityData) {
        ...
        log.info("CREATE student status: {}", entityData);
