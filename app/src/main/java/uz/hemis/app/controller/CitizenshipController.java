...
/**
 * University Citizenship Controller - CUBA REST API Pattern
 *
 * <p><strong>CRITICAL - OLD-HEMIS Compatibility:</strong></p>
 * <ul>
 *   <li>Entity name: hemishe_HCitizenship</li>
 *   <li>Maps to Classifier entity with type: CITIZENSHIP</li>
 *   <li>Base URL: /app/rest/v2/entities/hemishe_HCitizenship</li>
...
public class CitizenshipController {
    ...
    private static final String CLASSIFIER_TYPE = "CITIZENSHIP";

    // =====================================================
    // 1. GET BY ID
    // =====================================================

    @Operation(summary = "Get citizenship by ID",
    ...
    public ResponseEntity<Map<String, Object>> getById(
        ...
        log.info("GET citizenship by ID: {}", entityId);
    ...
    @Operation(summary = "Update citizenship",
    ...
    public ResponseEntity<Map<String, Object>> update(
        ...
        log.info("UPDATE citizenship: {}", entityId);
    ...
    @Operation(summary = "Delete citizenship",
    ...
    public ResponseEntity<Void> delete(
        ...
        log.info("DELETE citizenship: {}", entityId);
    ...
    @Operation(summary = "Search citizenships (GET)",
    ...
    public ResponseEntity<List<Map<String, Object>>> searchGet(
        ...
        log.info("SEARCH citizenships (GET) - filter: {}", filter);
    ...
    @Operation(summary = "Search citizenships (POST)",
    ...
    public ResponseEntity<List<Map<String, Object>>> searchPost(
        ...
        log.info("SEARCH citizenships (POST) - filter: {}", filterBody);
    ...
    @Operation(summary = "Get all citizenships",
    ...
    public ResponseEntity<List<Map<String, Object>>> listAll(
        ...
        log.info("LIST ALL citizenships");
    ...
    @Operation(summary = "Create new citizenship",
    ...
    public ResponseEntity<Map<String, Object>> create(@RequestBody Map<String, Object> entityData) {
        ...
        log.info("CREATE citizenship: {}", entityData);
