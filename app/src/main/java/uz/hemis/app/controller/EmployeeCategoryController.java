...
/**
 * University Employee Category Controller - CUBA REST API Pattern
 *
 * <p><strong>CRITICAL - OLD-HEMIS Compatibility:</strong></p>
 * <ul>
 *   <li>Entity name: hemishe_HEmployeeCategory</li>
 *   <li>Maps to Classifier entity with type: EMPLOYEE_CATEGORY</li>
 *   <li>Base URL: /app/rest/v2/entities/hemishe_HEmployeeCategory</li>
...
public class EmployeeCategoryController {
    ...
    @Operation(summary = "Get employee category by ID",
    ...
    public ResponseEntity<Map<String, Object>> getById(
        ...
        log.info("GET employee category by ID: {}", entityId);
    ...
    @Operation(summary = "Update employee category",
    ...
    public ResponseEntity<Map<String, Object>> update(
        ...
        log.info("UPDATE employee category: {}", entityId);
    ...
    @Operation(summary = "Delete employee category",
    ...
    public ResponseEntity<Void> delete(
        ...
        log.info("DELETE employee category: {}", entityId);
    ...
    @Operation(summary = "Search employee categorys (GET)",
    ...
    public ResponseEntity<List<Map<String, Object>>> searchGet(
        ...
        log.info("SEARCH employee categorys (GET) - filter: {}", filter);
    ...
    @Operation(summary = "Search employee categorys (POST)",
    ...
    public ResponseEntity<List<Map<String, Object>>> searchPost(
        ...
        log.info("SEARCH employee categorys (POST) - filter: {}", filterBody);
    ...
    @Operation(summary = "Get all employee categorys",
    ...
    public ResponseEntity<List<Map<String, Object>>> listAll(
        ...
        log.info("LIST ALL employee categorys");
    ...
    @Operation(summary = "Create new employee category",
    ...
    public ResponseEntity<Map<String, Object>> create(@RequestBody Map<String, Object> entityData) {
        ...
        log.info("CREATE employee category: {}", entityData);
