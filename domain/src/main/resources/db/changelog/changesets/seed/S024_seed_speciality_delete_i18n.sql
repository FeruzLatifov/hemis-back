...
PERFORM _seed_msg('label', 'Only a speciality with the "Needs review" status can be deleted',               'Faqat "Ko''rib chiqish kerak" holatidagi mutaxassislikni o''chirish mumkin',                     'Фақат "Кўриб чиқиш керак" ҳолатидаги мутахассисликни ўчириш мумкин',                      'Удалить можно только специальность со статусом «Требует проверки»');
