-- =====================================================
-- Rollback S026: remove the OTM attachment blocker keys
-- =====================================================
-- Deletes only the three keys S026 INTRODUCED (by explicit message_key list),
...
DECLARE
    _keys TEXT[] := ARRAY[
        ...
        'This speciality is attached to universities. Remove those attachments first.',
        'Revoked attachments also block deletion'
    ];
...
BEGIN
    ...
    RAISE NOTICE 'S026 Rollback: deleted % translation rows, % message rows',
