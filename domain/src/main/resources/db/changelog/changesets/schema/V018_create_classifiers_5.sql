...
FROM hemishe_h_attandance_setting WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_auditorium_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_device_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_diplom_blank_category WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_diplom_blank_generate_status WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_diplom_blank_status WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_internship_form WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_internship_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_publication_database WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_publication_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_project_executor_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_project_locality WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_project_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_resource_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_scholar_database WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_scientific_project_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_sport_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_teacher_achievement_type WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_teacher_conduction_form WHERE delete_ts IS NULL;
...
SELECT code, name, name_ru, name_en, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_workplace_compatibility WHERE delete_ts IS NULL;
...
INSERT INTO language_certificate (code, name, name_ru, name_en, certificate_language_code, is_active, version, created_at, created_by)
SELECT code, name, name_ru, name_en, _certificate_language, COALESCE(active, true), COALESCE(version, 1), COALESCE(create_ts, NOW()), 'system:migration'
FROM hemishe_h_language_certificate WHERE delete_ts IS NULL;
