-- =====================================================
-- V010: CADASTRE MODULE — university_cadastre
-- =====================================================
-- Author: hemis-team
-- Date: 2026-03-25
...
CREATE TABLE university_cadastre (
    ...
    -- Data integrity: data_source uyg'un bo'lishi kerak (V009 organization.source bilan bir xil pattern)
    CONSTRAINT chk_ucadastre_data_source CHECK (data_source IS NULL OR data_source IN ('api_kadastr', 'manual'))
);
