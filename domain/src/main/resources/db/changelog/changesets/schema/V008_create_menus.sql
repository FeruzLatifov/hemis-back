...
VALUES (
    ...
    'data-student-accomodation',
    'menu.data.student.accommodation',
    '/data/student/accomodation',
    'home',
    'data.student.view',
    4,
...
VALUES (
    ...
    'data-science-patent-type',
    'menu.data.science.patient_type',
    '/data/science/patent-type',
    'file-badge',
    'data.science.view',
    7,
...
VALUES (
    ...
    'data-employee-degree',
    'menu.data.employee.academic_degree',
    '/data/employee/degree',
    'graduation-cap',
    'data.employee.view',
    8,
...
VALUES (
    ...
    'data-employee-rank',
    'menu.data.employee.academic_rank',
    '/data/employee/rank',
    'trending-up',
    'data.employee.view',
    9,
...
VALUES (
    ...
    'data-student-type',
    'menu.data.student.student_type',
    '/data/student/type',
    'tag',
    'data.student.view',
    11,
...
VALUES (
    ...
    'data-study-conduction-form',
    'menu.data.study.teacher_conduction',
    '/data/study/conduction-form',
    'presentation',
    'data.study.view',
    14,
