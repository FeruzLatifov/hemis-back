...
COMMENT ON INDEX idx_student_pinfl IS
  'Performance: PINFL lookup for student verification (100x faster)';
...
COMMENT ON INDEX idx_student_university IS
  'Performance: Filter students by university';
...
COMMENT ON INDEX idx_student_status IS
  'Performance: Filter by status (11=active, 13=expelled, 16=graduated)';
...
COMMENT ON INDEX idx_student_uni_status IS
  'Performance: Composite index for university + status queries';
...
COMMENT ON INDEX idx_student_payment_form IS
  'Performance: Filter by payment form (11=budget, 12=contract)';
...
COMMENT ON INDEX idx_student_delete_ts IS
  'Performance: Optimize soft delete filtering';
...
COMMENT ON INDEX idx_student_course_year IS
  'Performance: Filter by course and education year';
...
COMMENT ON INDEX idx_student_faculty IS
  'Performance: Filter students by faculty';
...
COMMENT ON INDEX idx_student_speciality IS
  'Performance: Filter students by speciality';
...
COMMENT ON INDEX idx_student_create_ts IS
  'Performance: Date range queries for enrollment';
...
COMMENT ON INDEX idx_teacher_pinfl IS
  'Performance: Teacher lookup by PINFL';
...
COMMENT ON INDEX idx_teacher_university IS
  'Performance: List teachers by university';

-- Index 13: Teacher delete_ts
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_teacher_delete_ts
ON hemishe_e_teacher(delete_ts);

COMMENT ON INDEX idx_teacher_delete_ts IS
  'Performance: Soft delete filtering for teachers';
...
COMMENT ON INDEX idx_teacher_degree IS
  'Performance: Filter teachers by academic degree';
...
COMMENT ON INDEX idx_teacher_rank IS
  'Performance: Filter teachers by academic rank';
...
COMMENT ON INDEX idx_university_code IS
  'Performance: University lookup by code';
...
COMMENT ON INDEX idx_university_tin IS
  'Performance: University lookup by TIN for financial operations';
...
COMMENT ON INDEX idx_university_type IS
  'Performance: Filter universities by type';
...
COMMENT ON INDEX idx_diploma_hash IS
  'Performance: Diploma verification by hash (public API)';
...
COMMENT ON INDEX idx_diploma_pinfl IS
  'Performance: Get diploma by student PINFL';
...
COMMENT ON INDEX idx_diploma_student IS
  'Performance: Get diploma by student ID';
...
COMMENT ON INDEX idx_scholarship_student IS
  'Performance: Get scholarship by student';
...
COMMENT ON INDEX idx_scholarship_type IS
  'Performance: Filter scholarships by type';
...
COMMENT ON INDEX idx_scholarship_amount_month IS
  'Performance: Filter scholarship payments by month';
...
COMMENT ON INDEX idx_scholarship_amount_ref IS
  'Performance: Join scholarship amounts to scholarship';
...
COMMENT ON INDEX idx_verification_pinfl IS
  'Performance: Student verification trigger optimization';
...
COMMENT ON INDEX idx_employee_job_teacher IS
  'Performance: Get jobs by teacher';
...
COMMENT ON INDEX idx_employee_job_university IS
  'Performance: Get jobs by university';
...
COMMENT ON INDEX idx_department_university IS
  'Performance: List departments by university';
...
COMMENT ON INDEX idx_department_code IS
  'Performance: Department lookup by code';
...
COMMENT ON INDEX idx_speciality_university IS
  'Performance: List specialities by university';
...
COMMENT ON INDEX idx_speciality_code IS
  'Performance: Speciality lookup by code';
