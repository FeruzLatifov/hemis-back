...
public abstract class BaseEntity implements Serializable {
    ...
    /**
     * Equals based on ID. Uses {@code instanceof} to work correctly with Hibernate proxies
     * (proxied entities have a generated subclass, so {@code getClass() != o.getClass()} would
     * wrongly return {@code false} for equal entities).
     */
    @Override
