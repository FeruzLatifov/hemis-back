...
/**
 * Academic groups report (akademik guruhlar hisoboti).
 *
 * <p>Table: {@code hemishe_r_academic_group} (CUBA legacy report).</p>
 * <p>Audit columns populated via Spring Data JPA Auditing.</p>
 *
 * @since 1.0.0
 */
@Entity
@Table(name = "hemishe_r_academic_group")
@SQLRestriction("delete_ts IS NULL")
@EntityListeners(AuditingEntityListener.class)
@Getter
@Setter
public class AcademicGroup implements Serializable, Persistable<UUID> {
    ...
    @Column(name = "education_form_code")
    private String educationFormCode;

    @Column(name = "education_form_name")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AcademicGroup that)) return false;
